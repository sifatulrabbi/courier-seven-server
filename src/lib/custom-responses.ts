...
export class CustomResponse {
  ...
  static notFound(res: Response, message: string | false, errors: unknown) {
    new CustomResponse(res, 404, message ? message : 'Not Found', null, errors);
  }

  static unauthorized(res: Response, message: string | false, errors: unknown) {
    new CustomResponse(
      res,
      401,
  ...
  static forbidden(res: Response, message: string | false, errors: unknown) {
    new CustomResponse(res, 403, message ? message : 'Forbidden', null, errors);
  }

  static internal(res: Response, message: string | false, errors: unknown) {
    new CustomResponse(
      res,
      500,
