...
export const COOKIES = {
    otpAuth: '_auth_otp_header_',
    session: '_courier_007_user_',
};

export const RESPONSES = {
    otpSent:
        'An OTP was sent to the email address. Please check your inbox/spam folder',
    loginFailed: 'Use email and password to login',
};
